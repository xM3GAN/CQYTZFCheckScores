...
# 定义常量URL，广告内容的URL
AD_URL = "https://github.com/xM3GAN/CQYTZFCheckScores/main/data/advertise.txt"
# 定义常量URL，免广告用户列表的URL
NO_AD_USERS_LIST_URL = "https://github.com/xM3GAN/CQYTZFCheckScores/main/data/no_ad_users_list.txt"
